...
//=============================================================================
  {
    ...
    if (Ll.LlSelectFileDlgTitleEx(
        ...
        hWnd_,
        "",
        CmbtLL30.LL_PROJECT_LABEL | CmbtLL30.LL_FILE_ALSONEW,
        bufferFilename,
        0) < 0)
    {
      //Close the List & Label job
...
//=============================================================================
  {
    ...
    if (Ll.LlSelectFileDlgTitleEx(
        ...
        hWnd_,
        "",
        CmbtLL30.LL_PROJECT_LIST | CmbtLL30.LL_FILE_ALSONEW,
        bufferFilename,
        0) < 0)
    {
      //Close the List & Label job
    ...
    Ll.LlDefineFieldExt(nLLJob_, "NumericalField", "1", CmbtLL30.LL_NUMERIC, 0);
    ...
    //Call the desinger
    if (Ll.LlDefineLayout(nLLJob_, hWnd_, "Designer", CmbtLL30.LL_PROJECT_LIST,
                          bufferFilename.toString()) < 0)
    {
      JOptionPane.showMessageDialog(null, "Error by calling LlDefineLayout.",
                                    "List & Label Sample App",
...
//=============================================================================
  {
    ...
    if (Ll.LlPrintWithBoxStart(
        ...
        CmbtLL30.LL_PRINT_EXPORT,
        CmbtLL30.LL_BOXTYPE_NORMALMETER,
        hWnd_,
        "Printing...") < 0)
    {
      JOptionPane.showMessageDialog(
    ...
    Ll.LlPrintSetOption(
        nLLJob_,
        CmbtLL30.LL_PRNOPT_COPIES,
        CmbtLL30.LL_COPIES_HIDE);

    Ll.LlPrintSetOption(
        nLLJob_,
        CmbtLL30.LL_PRNOPT_STARTPAGE,
        1);

    Ll.LlPrintSetOption(
        nLLJob_,
        CmbtLL30.LL_PRNOPT_OFFSET,
        0);
    ...
    nLastPage = Ll.LlPrintGetOption(nLLJob_, CmbtLL30.LL_OPTION_LASTPAGE);
    nRecno = 1;
           ...
           && nErrorValue == 0)
    {
      ...
      if (nErrorValue == CmbtLL30.LL_ERR_USER_ABORTED)
      {
        Ll.LlPrintEnd(
            nLLJob_,
            0);
...
//=============================================================================
  {
    ...
    Ll.LlDefineFieldExt(nLLJob_, "Barcode_UPCE", "4|44444|44444",
                    CmbtLL30.LL_BARCODE_UPCA, 0);
    Ll.LlDefineFieldExt(nLLJob_, "Barcode_3OF9", "*TEST*", CmbtLL30.LL_BARCODE_3OF9,
                        0);
    ...
    Ll.LlDefineFieldExt(nLLJob_, "Barcode_POSTNET12", "44444-444444",
                    CmbtLL30.LL_BARCODE_POSTNET, 0);
    Ll.LlDefineFieldExt(nLLJob_, "Barcode_FIM", "A", CmbtLL30.LL_BARCODE_FIM, 0);
    ...
    while (nRecno < nRecCount &&
           (Ll.LlPrintGetCurrentPage(nLLJob_) <= nLastPage) &&
           (nErrorValue == 0 || nErrorValue == CmbtLL30.LL_WRN_REPEAT_DATA))
    {
      for (int i = 1; i < 10; i++)
      {
        if (i != 2)
    ...
    while (nErrorValue == CmbtLL30.LL_WRN_REPEAT_DATA)
    {
...
//=============================================================================
  {
    ...
    int nRet = Ll.LlProjectOpen(nLLJob_, CmbtLL30.LL_PROJECT_LIST, sFileName, CmbtLL30.LL_PRJOPEN_CD_CREATE_ALWAYS | CmbtLL30.LL_PRJOPEN_AM_READWRITE);
    if (nRet < 0)
    {
      JOptionPane.showMessageDialog(
          this,
    ...
    int nLinkMode = combit.CmbtLL30.LL_LINK_VPOS_END | combit.CmbtLL30.LL_LINK_VSIZE_INV;
