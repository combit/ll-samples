...
namespace DataBinding2
{
    public partial class Form1 : Form
    {
        ...
        private string _projectPath = Path.GetDirectoryName(Application.ExecutablePath) + @"..\..\..\..\..\..\..\Report Files\Cross Platform\";
        public Form1()
        {
        ...
        private void InitDataSet()
        {
            ...
            if (String.IsNullOrEmpty(databasePath))
            {
                ...
                //US: Disable Buttons
                btnInvoiceMergePrint.Enabled = false;
                btnInvoiceItemsPrint.Enabled = false;
        ...
        private void btnInvoiceItemsPrint_Click(object sender, EventArgs e)
        {
            try
            {
                using (ListLabel LL = new ListLabel())
                {
                    ...
                    LL.AutoProjectFile = Path.Combine(_projectPath, "inv_lst.json");

                    //D: ExportConfiguration erzeugen
                    //US: create ExportConfiguration
                    ExportConfiguration exportConfiguration = new ExportConfiguration(LlExportTarget.Pdf, Path.Combine(_projectPath, "export.pdf"), LL.AutoProjectFile);
                    ...
                    //D: List & Label Cross Platform Objekt freigeben
                    //US: Release List & Label Cross Platform object
                    LL.Dispose();
                }
            }
        ...
        private void btnInvoiceMergePrint_Click(object sender, EventArgs e)
        {           
            ...
            try
            {
                using (ListLabel LL = new ListLabel())
                {
                    ...
                    //D: Den Standard-Projektnamen setzen
                    //US: set the default project name
                    LL.AutoProjectFile = Path.Combine(_projectPath, "inv_merg.json");
