    ...
    public partial class Form1 : Form
    {
        ...
        private void InitDataSet()
        {
            ...
            if (String.IsNullOrEmpty(databasePath))
            {
                ...
                //US: Disable Buttons
                buttonInvoiceMergeDesign.Enabled = false;
                buttonInvoiceMergePrint.Enabled = false;
                buttonInvoiceItemsPrint.Enabled = false;
                buttonInvoiceItemsDesign.Enabled = false;
            }
            else
            {
        ...
        private void ButtonInvoiceMergeDesign_Click(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void ButtonInvoiceMergePrint_Click(object sender, System.EventArgs e)
        {
            try
            {
                //D: Die order master Daten sollen als Variablen angemeldet werden
        ...
        private void ButtonInvoiceItemsDesign_Click(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void ButtonInvoiceItemsPrint_Click(object sender, System.EventArgs e)
        {
            try
            {
                //D: Die order master Daten sollen als Felder angemeldet werden
