...
namespace Custom_Logger_Sample
{
    ...
    public class ListViewLogger : LoggerBase
    {
        ...
        public override bool WantOutput(LogLevels level, LogCategory category)
        {
            ...
            {
                LogCategory.API => _selectedCategories.EnableApiCalls,
                LogCategory.DataProvider => _selectedCategories.EnableDataProvider,
                LogCategory.Licensing => _selectedCategories.EnableLicensing,
                LogCategory.Net => _selectedCategories.EnableDotNetComponent,
                LogCategory.Printer => _selectedCategories.EnablePrinterInformation,
                _ => _selectedCategories.EnableOther,
            };
        }
