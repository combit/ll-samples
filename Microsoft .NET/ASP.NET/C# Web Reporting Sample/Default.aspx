<%@ Page Language="c#" Inherits="WebReporting.Default" MasterPageFile="~/Root.master" UICulture="auto" CodeBehind="Default.aspx.cs" Culture="auto" meta:resourcekey="PageResource1" %>
    ...
    <form id="Form1" clientidmode="Static" method="post" runat="server">
        <div data-role="header" id="MainToolbar">
            <div data-role="controlgroup" data-type="horizontal">
                ...
                <asp:LinkButton data-role="button" ID="LinkButtonRefresh" runat="server" data-icon="eye" data-iconpos="right" OnClick="DropDownListProjectFile_SelectedIndexChanged">Html5Viewer</asp:LinkButton>
