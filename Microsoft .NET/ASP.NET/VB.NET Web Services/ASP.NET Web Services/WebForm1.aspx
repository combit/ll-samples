<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="WebForm1.aspx.vb" Inherits="ASP.NET_Web_Services.WebForm1" %>
...
<body>
    ...
    <asp:ScriptManager EnablePageMethods="true" runat="server" ScriptMode="Auto">
        <Services>
            <asp:ServiceReference Path="~/ReportingService.asmx" />
        </Services>
        <Scripts>
    ...
    <div data-role="page">
        ...
        <div data-role="footer" data-position="fixed">
            <h4>
                <a href="http://www.combit.net/reporting/report-generator-List-Label" target="_blank">Powered by combit List & Label</a>
            </h4>
        </div>
    </div>
    <!-- /page -->
