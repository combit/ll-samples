            ...
            Try
                ...
                Select Case dataSourceId.ToUpperInvariant()
                    ...
                    Case "XML2"
                        ...
                        Exit Select
                    Case "JSON"
                        provider = New Global.combit.ListLabel24.DataProviders.JsonDataProvider(File.ReadAllText(Path.Combine(Server.MapPath("~/App_Data"), "data.json")))
                        Exit Select
                    Case "OBJECT"
                ...
                Using ll As New ListLabel()
                    ...
                    'll.Debug = combit.ListLabel24.LlDebug.Enabled;
