<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="ASPDOMSample._Default" %>
...
<body>
    ...
    <div style="margin-left: 25%;">
        <fieldset id="Fieldset1" class="fs" runat="server">
            ...
            <!-- field table -->
            <table id="Table1" runat="server" style="width: 100%; margin-top: 10px;">
                <tr>
        ...
        <fieldset id="Fieldset2" class="fs" runat="server">
