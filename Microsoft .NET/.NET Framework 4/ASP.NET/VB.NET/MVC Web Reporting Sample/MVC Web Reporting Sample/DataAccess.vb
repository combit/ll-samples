...
Namespace DataAccess
    ...
    Public NotInheritable Class SampleData
        Private Sub New()
        End Sub
        Public Shared Function CreateProviderCollection(reportName As String, forDesign As Boolean) As DataProviderCollection
            ...
            If (Not forDesign) AndAlso (cachedCollection IsNot Nothing) Then
            ...
            Else
                ...
                cachePolicy.AbsoluteExpiration = DateTimeOffset.Now.AddMinutes(30.0)
...
#Region "Gantt DB"
        Public Shared Function GantDS() As DataSet
            ...
            Try
                ...
                Dim tablesWithDates As New Dictionary(Of String, List(Of String))()
                tablesWithDates.Add("Project", New List(Of String)() From {
                    "BeginDate"
                })
                tablesWithDates.Add("Pollen", New List(Of String)() From {
                    "PeriodBegin",
                    "PeriodEnd"
                })
        ...
        Private Shared Sub GetFilteredData(tableName As String)
            ...
            ElseIf tableName = "Employees" Then
                ...
                result = From e In dtEmployees.AsEnumerable()
                         Join o In dtOrders.AsEnumerable()
                         On e.Field(Of Integer)("EmployeeID") Equals o.Field(Of Integer)("EmployeeID")
                         Select e
