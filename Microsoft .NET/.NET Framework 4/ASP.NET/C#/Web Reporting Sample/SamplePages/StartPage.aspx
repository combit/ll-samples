<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StartPage.aspx.cs" MasterPageFile="SamplePages.master" Inherits="WebReporting.StartPage" %>
                        ...
                        <ItemTemplate>
                            <div data-role="collapsible" data-mini="true">
                                ...
                                <table class="RepositoryItemTable">
                                    <tr>
                                        <td>ID:</td>
                                        <td><%# ((CustomizedRepostoryItem)Container.DataItem).InternalID %></td>
                                        <td>Author:</td>
                                        <td><%# ((CustomizedRepostoryItem)Container.DataItem).Author %></td>
                                    </tr>
                                    <tr>
                                        <td>Type:</td>
                                        <td><%# ((CustomizedRepostoryItem)Container.DataItem).Type %></td>
                                        <td>Last Modification:</td>
                                        <td><%# ((CustomizedRepostoryItem)Container.DataItem).LastModificationUTC.ToLocalTime() %></td>
                                    </tr>
                                </table>
                                <div style="text-align: right">
                                    <asp:HyperLink ID="LinkHtml5Viewer" runat="server" Visible="false" data-ajax="false" data-role="button" data-mini="true" data-inline="true">HTML5 Viewer</asp:HyperLink>
