...
namespace DataAccess
{
    static class CmbtSettings
    {
        ...
        public static List<string> UnlimitedRecordsList
        {
            get
            {
                return new List<string>() { "Customer list with sort order.srt", "Crosstab with comparison of previous year.srt", "Conditional formatting and native aggregate functions.srt" };
            }
        }
        ...
        public static List<string> IsEmployeeList
        {
            get
            {
                return new List<string>() { "Mixed portrait and landscape.srt", "Crosstab.srt" };
            }
        }
    }
    ...
    {
        public static DataProviderCollection CreateProviderCollection(string reportName)
        {
