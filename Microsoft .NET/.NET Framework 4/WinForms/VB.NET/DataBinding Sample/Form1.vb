...
Partial Public Class Form1
    ...
    Public Sub New()
        ...
        If installKey IsNot Nothing Then
            ...
            _xmlFile = Path.Combine(installKey.GetValue("LL" + LlCore.LlGetVersion(LlVersion.Major).ToString + "SampleDir").ToString(), "Microsoft .NET\Report Files\\sampledata.xml")
            _isNotPrinting = True
        End If
    ...
    Private Function CreateProviderCollection(ByVal useDataViewManager As Boolean) As DataProviderCollection
        ...
        Dim provider As New CsvDataProvider(Application.StartupPath & "\..\..\..\..\..\..\Report Files\Sales.csv", True)
