...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            if (installKey != null)
                sampleDir = (string)installKey.GetValue("LL31SampleDir", string.Empty);

            if (!sampleDir.EndsWith("\\"))
                sampleDir += "\\";

            SourceFileName = sampleDir + @"Microsoft .NET\.NET Framework 4\WinForms\RDL Reports Converter Sample\RDLConverter\RDlReports.rdl";
            TargetFileName = sampleDir + @"Microsoft .NET\.NET Framework 4\WinForms\RDL Reports Converter Sample\RDLConverter\ReportConvert.lst";
