...
namespace LocalizationSample
{
    public partial class LocalizationForm : Form
    {
        ...
        private void FillStaticTextDictionary()
        {
            ...
            LL.Dictionary.StaticTexts.Add("Summary of Sales by Year", "Chiffre d'affaires à l'année", _designerLanguageLCIDfr);
            ...
            LL.Dictionary.StaticTexts.Add("Sales by Year", "Volume d'affaires à l'année", _designerLanguageLCIDfr);
            LL.Dictionary.StaticTexts.Add("Lot by Year", "Nombre de pièces à l'année", _designerLanguageLCIDfr);
