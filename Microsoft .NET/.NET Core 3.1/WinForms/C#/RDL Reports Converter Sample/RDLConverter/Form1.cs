...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            SourceFileName = sampleDir + @"Microsoft .NET\.NET Core 3.1\WinForms\C#\Rdl Reports Converter Sample\RdlConverter\RDlReports.rdl";
            TargetFileName = sampleDir + @"Microsoft .NET\.NET Core 3.1\WinForms\C#\Rdl Reports Converter Sample\RdlConverter\ReportConvert.lst";
