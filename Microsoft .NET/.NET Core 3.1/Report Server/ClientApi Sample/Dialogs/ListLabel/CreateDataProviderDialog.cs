    ...
    public partial class CreateDataProviderDialog : Form
    {
        ...
        private async void btnApply_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var csvDataProvider = new combit.Reporting.DataProviders.CsvDataProvider(txtCsvFilePath.Text, chkCsvFirstLineHeaders.Checked, txtCsvTableName.Text, txtCsvSeparatorChar.Text[0]);
