...
Imports combit.ListLabel24.Converters
...
Partial Public Class Form1
    ...
    Public Sub New()
        ...
        If installKey IsNot Nothing Then
            sampleDir = DirectCast(installKey.GetValue("LL24SampleDir", String.Empty), String)
        End If
        ...
        SourceFileName = sampleDir + "Microsoft .NET\VB.NET Rdl Reports Converter\RdlConverter\RDlReports.rdl"
        TargetFileName = sampleDir + "Microsoft .NET\VB.NET Rdl Reports Converter\RdlConverter\ReportConvert.lst"
    ...
    Private Sub SelectSourceFile_Click(sender As Object, e As EventArgs) Handles selectSourceFile.Click
        Try
            ...
            openFileDialog.InitialDirectory = sampleDir + "Microsoft .NET"
    ...
    Private Sub SelectTargetFile_Click(sender As Object, e As EventArgs) Handles selectTargetFile.Click
        Try
            ...
            saveFileDialog.InitialDirectory = sampleDir + "Microsoft .NET"
    ...
    Private Sub TextTargetFile_MouseEnter(sender As Object, e As EventArgs) Handles textSourceFile.MouseEnter, textTargetFile.MouseEnter
        If TryCast(sender, MetroFramework.Controls.MetroTextBox).Name = textSourceFile.Name Then
            toolTip1.Show(textSourceFile.Text, textSourceFile)
        ElseIf TryCast(sender, MetroFramework.Controls.MetroTextBox).Name = textTargetFile.Name Then
    ...
    Private Sub TextSourceFile_MouseLeave(sender As Object, e As EventArgs) Handles textSourceFile.MouseLeave, textTargetFile.MouseLeave
        toolTip1.Hide(TryCast(sender, MetroFramework.Controls.MetroTextBox))
    End Sub
