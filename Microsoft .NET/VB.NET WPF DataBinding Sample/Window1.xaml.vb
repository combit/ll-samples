	...
	Public Partial Class Window1
		...
		Public Sub New()
			...
			If installKey IsNot Nothing Then
                ...
                _xmlFile = System.IO.Path.Combine(installKey.GetValue("LL" + LlCore.LlGetVersion(LlVersion.Major).ToString + "SampleDir").ToString(), "Microsoft .NET\\sampledata.xml")
                _isNotPrinting = True
			End If
		...
		Private Function CreateProviderCollection(useDataViewManager As Boolean) As DataProviderCollection
            ...
            Dim provider As New CsvDataProvider(System.AppDomain.CurrentDomain.BaseDirectory & "\..\..\..\Sales.csv", True)
        ...
        Private Sub Design_XML_Click(sender As Object, e As RoutedEventArgs)
            ...
            If xmlDocument IsNot Nothing Then
                Try
                    ...
                    Dim provider As New combit.ListLabel24.DataProviders.XmlDataProvider(xmlDocument)
