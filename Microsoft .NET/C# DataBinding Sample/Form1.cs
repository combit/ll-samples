    ...
    public partial class Form1 : MetroForm
    {
        ...
        public Form1()
        {
            ...
            if (installKey != null)
            {
				...
				_xmlFile = Path.Combine(installKey.GetValue("LL" + LlCore.LlGetVersion(LlVersion.Major) + "SampleDir").ToString(), "Microsoft .NET\\sampledata.xml");
                _isNotPrinting = true;
            }
        ...
        private DataProviderCollection CreateProviderCollection(bool useDataViewManager)
        {
            ...
            CsvDataProvider provider = new CsvDataProvider(Application.StartupPath + @"\..\..\..\Sales.csv", true);
