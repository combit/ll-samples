...
PROCEDURE CreateMainWindow()
   ...
   oDlg := XbpDialog():new()
   oDlg:title    := "List & Label 31 Xbase++ - Demo"
...
RETURN
    ...
    ConfirmBox(SetAppWindow() , "List & Label 31 Xbase++ Demo (c) 1999-2011 combit GmbH", "About", XBPMB_OK , XBPMB_INFORMATION+XBPMB_APPMODAL+XBPMB_MOVEABLE )
    RETURN
