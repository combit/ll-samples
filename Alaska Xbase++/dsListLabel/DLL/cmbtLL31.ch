// Alaska Software Xbase++ header constants and function definitions for LL31.DLL
//  (c) combit GmbH
//  [build of 2025-07-09 07:07:49]

// HEADER file to be included in all modules using LL31

#ifndef _LL31_CH // include header only once
#define _LL31_CH
...
#define LL_JOBHANDLE_IDMASK            (0x0fffffff)        
...
#define LL_COMBINATIONPRINTSTEP_SKIP   (0x100)             
#define LL_NTFY_COMBINATIONPRINTSTEP   (115)                /* lParam = &scLlCombinationPrintStep, return 0 on OK, 1 to reset the page number, 2 to reset the page number, and total pages, LL_COMBINATIONPRINTSTEP_SKIP to skip the project, or error code on error */
...
#define LL_TREEVIEWFILTER_IN_TABLESTRUCTWIN (0x0004)            
...
#define LL_OPTION_COMPAT_SET_FIRST_USER_DEFINE_PAPER_INDEX_TO_DMPAPER_USER (430)                /* default: false */
#define LL_OPTION_USE_SVG2EMF_OOPS     (431)                /* default: false */
#define LL_OPTION_ENABLE_NESTEDTABLE_IN_FOOTERLINES (432)                /* default: false */
#define LL_OPTION_ENABLE_EUDC          (433)                /* default: false */
#define LL_OPTION_DISABLEPRINT_MENU    (434)                /* default: 0 */
#define LL_OPTION_DISABLEPRINT_MENU_PRINT (0x01)               /* disable menu item  */
#define LL_OPTION_DISABLEPRINT_MENU_PRINTQUICK (0x02)               /* disable menu item  */
#define LL_OPTION_DISABLEPRINT_MENU_PAGE1 (0x04)               /* disable menu item  */
#define LL_OPTION_DISABLEPRINT_MENU_PAGEN (0x08)               /* disable menu item  */
#define LL_OPTION_DISABLEPRINT_MENU_DUMMY (0x10)               /* disable menu item  */
#define LL_OPTION_DISABLEPRINT_MENU_PREVIEW (0x20)               /* disable menu item  */
#define LL_OPTION_DISABLEPRINT_MENU_ALL (0xFF)               /* disable menu item (mask all)  */
#define LL_OPTION_RIBBON_FORCEENABLED  (435)                /* default: false */
