VERSION 5.00
Object = "{2213E283-16BC-101D-AFD4-040224009C11}#24.0#0"; "cmll24o.ocx"
Begin VB.UserControl ListLabelVB 
   ...
   Begin VB.Label Label4 
      ...
      Caption         =   "D: Hilfe siehe cmll24o.hlp"
      Height          =   195
      Left            =   960
      TabIndex        =   3
      Top             =   960
   ...
   Begin VB.Label Label3 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "US: For help see cmll24o.hlp"
      Height          =   195
      Left            =   960
      TabIndex        =   2
      Top             =   1200
...
Public Sub Deb(ByVal Out As String)
    ...
    If Not DebWin2 Is Nothing Then
        DebWin2.WriteLine "cmll24VB: " & Out
    End If
End Sub
