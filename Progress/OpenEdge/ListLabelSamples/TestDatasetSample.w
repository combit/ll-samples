...
DEFINE FRAME fMain
     BUTTON-1 AT ROW 1.71 COL 13 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 80 BY 3.62 WIDGET-ID 100.
...
DO:
   ...
   IF LOOKUP (cPath, PROPATH) = 0 THEN
   DO:
       PROPATH = cPath + "," + PROPATH.
   END.

  RUN listLabelSamples/DatasetSample.p.
END.
